...
public  class  ch13_2  {
        ...
        public  static  void  main(String[]  args)  throws  Exception  {
                ...
                BufferedImage  nbi=fushi(bi);                                                //处理图像
                ImageIO.write(nbi,  "jpg",  new  File("output/ch13_2.jpg"));                //输出图像
        ...
        /**
          ...
          *  */
        public  static  BufferedImage  fushi(BufferedImage  bi)  {
                ...
                for(int  y=1;y<(h-1);y++)  {
                        for(int  x=1;x<(w-1);x++)  {
                                int  r=fushi(getSz(bi,x,y,1));
                                int  g=fushi(getSz(bi,x,y,2));
                                int  b=fushi(getSz(bi,x,y,3));
        ...
        /**
          ...
          *  @return  int                                像素值（最大值）
          *  */
        private  static  int  fushi(int[]  sz)  {
        	int min=255;
